const Validate = (event) =>{
    ...
    let firstName = document.signouts.firstname;
    let lastName = document.signouts.lastname;
    let key = document.signouts.securitykey;
    let phoneNumber = document.signouts.phonenumber;
    let time = document.signouts.time;
    let date = document.signouts.date;
    let gender = document.signouts.gender;
    let nin = document.signouts.nin;
